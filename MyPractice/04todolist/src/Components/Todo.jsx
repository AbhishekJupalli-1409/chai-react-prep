            ...
            <div
             ...
             <div className='w-full flex flex-col gap-3'>
              <div className='flex w-full justify-between'>
                    <div className='text-gray-800 font-semibold flex gap-2'>
                      <input
                        style={{ transform: "scale(1.5)",accentColor: "#2b2b2ccc" }}
                       type='checkbox' onChange={()=>handleStrike(todo.id)} className='  border-grey-200 focus:border-grey-500 bg-yellow-600 py-1 px-3 rounded-md text-gray-800 cursor-pointer'></input>
                          {/* {console.log(todo.id)} */}
                    </div>
                    
                    <div className='flex gap-3'>
                        <button className='bg-yellow-600 py-1 px-3 rounded-md text-gray-800 cursor-pointer' onClick={handleEdit}>
                          /
                        </button>
                        <button className='bg-red-600 py-1 px-3 rounded-md text-gray-800 cursor-pointer' onClick={()=>handleDelete(todo.id)}>
                          X
                        </button>
                    </div>
              </div>
              <div className="text-lg block text-gray-800 font-semibold text-left" style={{
